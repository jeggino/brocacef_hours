...
if selected == '📊':
    ...
    st.markdown(f"The **{max_day_2['day_of_the_week']}** ({max_day_2['date']}) is the day when you work more , and the **{less_day_2['day_of_the_week']}** ({less_day_2['date']}) is the day when you work less ({less_day_hours}) ")
